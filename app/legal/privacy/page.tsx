  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12 text-lg text-foreground">
        ...
        <p className="mb-2">We may ask for personal information which may include one or more of the following:</p>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-2">Legitimate Reasons for Processing Your Personal Information</h2>
        <p className="mb-4">
          We only collect and use your personal information when we have a legitimate reason for doing so. In which instance, we only collect personal information that is reasonably necessary to provide our services to you.
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-2">Collection and Use of Information</h2>
        <p className="mb-2">We may collect personal information from you when you do any of the following on our website:</p>
        <ul className="list-disc list-inside mb-4">
        ...
        <p className="mb-2">We may collect, hold, use, and disclose information for the following purposes, and personal information will not be further processed in a manner that is incompatible with these purposes:</p>
        <ul className="list-disc list-inside mb-4">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-2">Security of Your Personal Information</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-2">How Long We Keep Your Personal Information</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-2">Disclosure of Personal Information to Third Parties</h2>
        ...
        <h2 className="text-xl font-semibold mt-8 mb-2">International Transfers of Personal Information</h2>
        <p className="mb-4">
          The personal information we collect is stored and/or processed where we or our partners, affiliates, and third-party providers maintain facilities. Please be aware that the locations to which we store, process, or transfer your personal information may not have the same data protection laws as the country in which you initially provided the information. If we transfer your personal information to third parties in other countries: (i) we will perform those transfers in accordance with the requirements of applicable law; and (ii) we will protect the transferred personal information in accordance with this privacy policy.
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-2">Your Rights and Controlling Your Personal Information</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-2">Use of Cookies</h2>
        <p className="mb-4">
          We use "cookies" to collect information about you and your activity across our site. A cookie is a small piece of data that our website stores on your computer, and accesses each time you visit, so we can understand how you use our site. This helps us serve you content based on preferences you have specified.
        </p>

        <h2 className="text-xl font-semibold mt-8 mb-2">Limits of Our Policy</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-8 mb-2">Use of Google Workspace APIs</h2>
        <p className="mb-2">ADSC uses Google Workspace APIs to provide certain functionalities within our service. We want to explicitly affirm that:</p>
        <ul className="list-disc list-inside mb-4">
        ...
        <p className="mb-4">
          Our use of Google Workspace APIs is limited to enhancing your experience within ADSC and does not extend to any form of generalized AI or ML model development.
        </p>
        ...
        <p className="mb-2 font-semibold">ADSC Support Team</p>
        <p>Email: <a href="mailto:privacy@adsc.com" className="underline hover:text-primary transition-colors">privacy@adsc.com</a></p>
      </main>
      <LandingFooter />
    </>
  );
